...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @class(['dark' => ($appearance ?? 'system') == 'dark'])>
    <head>
        ...
        <link rel="icon" href="{{ asset('images/foto-mempelai/1.webp') }}" type="image/webp">
        <link rel="apple-touch-icon" href="{{ asset('images/foto-mempelai/1.webp') }}">
        ...
        <meta property="og:image" content="{{ asset('images/foto-mempelai/1.webp') }}" />
